...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({ isDark, toggle }) => {
  return (
    <button
      onClick={toggle}
      className="fixed top-4 right-4 z-50 p-2 rounded-full bg-zinc-200 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 hover:ring-2 hover:ring-blue-500 transition-all duration-300 shadow-md"
      ...
      {isDark ? (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M21.75 12.75a9.75 9.75 0 11-10.5-10.5 9.75 9.75 0 0010.5 10.5z"
          />
        </svg>
      )}
    </button>
